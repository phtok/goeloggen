...
FD="assets/fonts/goetheanum/Fonts/"; VF="assets/fonts/goetheanum/Variable/Goetheanum-Variabel-v2.4.0.otf"
...
IC=L(FD+"Goetheanum-Icons-v2.4.0.otf")
S=[]
...
txt(K,"Goetheanum Schriften Version 2.4.0 · Goetheanum Kommunikation, basierend auf Titillium (Urbino, SIL OFL).",9,M,557,"#737a80")
